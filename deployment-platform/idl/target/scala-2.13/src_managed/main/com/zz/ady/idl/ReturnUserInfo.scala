...
/** 用户列表返回
  ...
  */
@SerialVersionUID(0L)
final case class ReturnUserInfo(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ReturnUserInfo] {
    @transient
    ...
    def withId(__v: _root_.scala.Int): ReturnUserInfo = copy(id = __v)
    def withName(__v: _root_.scala.Predef.String): ReturnUserInfo = copy(name = __v)
    def withRoleId(__v: _root_.scala.Int): ReturnUserInfo = copy(roleId = __v)
    def withRoleName(__v: _root_.scala.Predef.String): ReturnUserInfo = copy(roleName = __v)
    def withCreatedAt(__v: _root_.scala.Predef.String): ReturnUserInfo = copy(createdAt = __v)
    def withUpdatedAt(__v: _root_.scala.Predef.String): ReturnUserInfo = copy(updatedAt = __v)
    def withIsDeleted(__v: _root_.scala.Int): ReturnUserInfo = copy(isDeleted = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 4 => _root_.scalapb.descriptors.PString(roleName)
    ...
    def companion = com.zz.ady.idl.ReturnUserInfo
}

object ReturnUserInfo extends scalapb.GeneratedMessageCompanion[com.zz.ady.idl.ReturnUserInfo] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zz.ady.idl.ReturnUserInfo] = this
  def merge(`_message__`: com.zz.ady.idl.ReturnUserInfo, `_input__`: _root_.com.google.protobuf.CodedInputStream): com.zz.ady.idl.ReturnUserInfo = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zz.ady.idl.ReturnUserInfo] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.zz.ady.idl.ReturnUserInfo(
        ...
        roleName = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = UserInfoApiProto.javaDescriptor.getMessageTypes.get(3)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = UserInfoApiProto.scalaDescriptor.messages(3)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zz.ady.idl.ReturnUserInfo(
    id = 0,
    name = "",
    roleId = 0,
    roleName = "",
  ...
  implicit class ReturnUserInfoLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zz.ady.idl.ReturnUserInfo]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zz.ady.idl.ReturnUserInfo](_l) {
  ...
  final val ROLE_NAME_FIELD_NUMBER = 4
  ...
  ): _root_.com.zz.ady.idl.ReturnUserInfo = _root_.com.zz.ady.idl.ReturnUserInfo(
    id,
    name,
    roleId,
    roleName,
