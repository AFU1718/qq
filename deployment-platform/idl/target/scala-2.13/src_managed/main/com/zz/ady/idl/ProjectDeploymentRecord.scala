...
final case class ProjectDeploymentRecord(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ProjectDeploymentRecord] {
    @transient
    ...
    def withId(__v: _root_.scala.Int): ProjectDeploymentRecord = copy(id = __v)
    def withProjectId(__v: _root_.scala.Int): ProjectDeploymentRecord = copy(projectId = __v)
    def withStatus(__v: _root_.scala.Int): ProjectDeploymentRecord = copy(status = __v)
    def withVersion(__v: _root_.scala.Predef.String): ProjectDeploymentRecord = copy(version = __v)
    def withChangeLog(__v: _root_.scala.Predef.String): ProjectDeploymentRecord = copy(changeLog = __v)
    def withDevelopers(__v: _root_.scala.Predef.String): ProjectDeploymentRecord = copy(developers = __v)
    def withTesters(__v: _root_.scala.Predef.String): ProjectDeploymentRecord = copy(testers = __v)
    def withDeployedAt(__v: _root_.scala.Predef.String): ProjectDeploymentRecord = copy(deployedAt = __v)
    def withTotalTime(__v: _root_.scala.Int): ProjectDeploymentRecord = copy(totalTime = __v)
    def withNote(__v: _root_.scala.Predef.String): ProjectDeploymentRecord = copy(note = __v)
    def withCreatedBy(__v: _root_.scala.Int): ProjectDeploymentRecord = copy(createdBy = __v)
    def withUpdatedBy(__v: _root_.scala.Int): ProjectDeploymentRecord = copy(updatedBy = __v)
    def withCreatedAt(__v: _root_.scala.Predef.String): ProjectDeploymentRecord = copy(createdAt = __v)
    def withUpdatedAt(__v: _root_.scala.Predef.String): ProjectDeploymentRecord = copy(updatedAt = __v)
    def withIsDeleted(__v: _root_.scala.Int): ProjectDeploymentRecord = copy(isDeleted = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.scalapb.descriptors.PInt(status)
        case 4 => _root_.scalapb.descriptors.PString(version)
        case 5 => _root_.scalapb.descriptors.PString(changeLog)
        case 6 => _root_.scalapb.descriptors.PString(developers)
        case 7 => _root_.scalapb.descriptors.PString(testers)
        case 8 => _root_.scalapb.descriptors.PString(deployedAt)
        case 9 => _root_.scalapb.descriptors.PInt(totalTime)
        case 10 => _root_.scalapb.descriptors.PString(note)
        case 11 => _root_.scalapb.descriptors.PInt(createdBy)
        case 12 => _root_.scalapb.descriptors.PInt(updatedBy)
        case 13 => _root_.scalapb.descriptors.PString(createdAt)
        case 14 => _root_.scalapb.descriptors.PString(updatedAt)
        case 15 => _root_.scalapb.descriptors.PInt(isDeleted)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion = com.zz.ady.idl.ProjectDeploymentRecord
}

object ProjectDeploymentRecord extends scalapb.GeneratedMessageCompanion[com.zz.ady.idl.ProjectDeploymentRecord] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zz.ady.idl.ProjectDeploymentRecord] = this
  def merge(`_message__`: com.zz.ady.idl.ProjectDeploymentRecord, `_input__`: _root_.com.google.protobuf.CodedInputStream): com.zz.ady.idl.ProjectDeploymentRecord = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zz.ady.idl.ProjectDeploymentRecord] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.zz.ady.idl.ProjectDeploymentRecord(
        ...
        status = __fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scala.Int]).getOrElse(0),
        version = __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        changeLog = __fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        developers = __fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        testers = __fieldsMap.get(scalaDescriptor.findFieldByNumber(7).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        deployedAt = __fieldsMap.get(scalaDescriptor.findFieldByNumber(8).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        totalTime = __fieldsMap.get(scalaDescriptor.findFieldByNumber(9).get).map(_.as[_root_.scala.Int]).getOrElse(0),
        note = __fieldsMap.get(scalaDescriptor.findFieldByNumber(10).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        createdBy = __fieldsMap.get(scalaDescriptor.findFieldByNumber(11).get).map(_.as[_root_.scala.Int]).getOrElse(0),
        updatedBy = __fieldsMap.get(scalaDescriptor.findFieldByNumber(12).get).map(_.as[_root_.scala.Int]).getOrElse(0),
        createdAt = __fieldsMap.get(scalaDescriptor.findFieldByNumber(13).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        updatedAt = __fieldsMap.get(scalaDescriptor.findFieldByNumber(14).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        isDeleted = __fieldsMap.get(scalaDescriptor.findFieldByNumber(15).get).map(_.as[_root_.scala.Int]).getOrElse(0)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ProjectDeploymentRecordApiProto.javaDescriptor.getMessageTypes.get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ProjectDeploymentRecordApiProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = com.zz.ady.idl.ProjectDeploymentRecord(
    id = 0,
    projectId = 0,
    status = 0,
    version = "",
  ...
  implicit class ProjectDeploymentRecordLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zz.ady.idl.ProjectDeploymentRecord]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zz.ady.idl.ProjectDeploymentRecord](_l) {
  ...
  final val CHANGE_LOG_FIELD_NUMBER = 5
  final val DEVELOPERS_FIELD_NUMBER = 6
  final val TESTERS_FIELD_NUMBER = 7
  final val DEPLOYED_AT_FIELD_NUMBER = 8
  final val TOTAL_TIME_FIELD_NUMBER = 9
  final val NOTE_FIELD_NUMBER = 10
  final val CREATED_BY_FIELD_NUMBER = 11
  final val UPDATED_BY_FIELD_NUMBER = 12
  final val CREATED_AT_FIELD_NUMBER = 13
  final val UPDATED_AT_FIELD_NUMBER = 14
  final val IS_DELETED_FIELD_NUMBER = 15
  def of(
    id: _root_.scala.Int,
  ...
  ): _root_.com.zz.ady.idl.ProjectDeploymentRecord = _root_.com.zz.ady.idl.ProjectDeploymentRecord(
    id,
    projectId,
    status,
    version,
