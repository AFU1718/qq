...
sealed abstract class PlacementType(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
  ...
  def companion: _root_.scalapb.GeneratedEnumCompanion[PlacementType] = com.zz.ady.idl.PlacementType
  final def asRecognized: _root_.scala.Option[com.zz.ady.idl.PlacementType.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[com.zz.ady.idl.PlacementType.Recognized])
}
