...
/** 查询DSP列表返回
  ...
  */
@SerialVersionUID(0L)
final case class QueryDspListResult(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[QueryDspListResult] {
    @transient
    ...
    def withId(__v: _root_.scala.Int): QueryDspListResult = copy(id = __v)
    def withName(__v: _root_.scala.Predef.String): QueryDspListResult = copy(name = __v)
    def withCode(__v: _root_.scala.Predef.String): QueryDspListResult = copy(code = __v)
    def withStatus(__v: com.zz.ady.backstage.idl.Status): QueryDspListResult = copy(status = __v)
    ...
    def companion = com.zz.ady.backstage.idl.QueryDspListResult
}

object QueryDspListResult extends scalapb.GeneratedMessageCompanion[com.zz.ady.backstage.idl.QueryDspListResult] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[com.zz.ady.backstage.idl.QueryDspListResult] = this
  def merge(`_message__`: com.zz.ady.backstage.idl.QueryDspListResult, `_input__`: _root_.com.google.protobuf.CodedInputStream): com.zz.ady.backstage.idl.QueryDspListResult = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.zz.ady.backstage.idl.QueryDspListResult] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = DspProto.javaDescriptor.getMessageTypes.get(7)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = DspProto.scalaDescriptor.messages(7)
  ...
  lazy val defaultInstance = com.zz.ady.backstage.idl.QueryDspListResult(
    id = 0,
    name = "",
    code = "",
    status = com.zz.ady.backstage.idl.Status.INACTIVE
  )
  implicit class QueryDspListResultLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.zz.ady.backstage.idl.QueryDspListResult]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.zz.ady.backstage.idl.QueryDspListResult](_l) {
  ...
  ): _root_.com.zz.ady.backstage.idl.QueryDspListResult = _root_.com.zz.ady.backstage.idl.QueryDspListResult(
    id,
    name,
    code,
    status
