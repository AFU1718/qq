...
sealed abstract class Status(val value: _root_.scala.Int) extends _root_.scalapb.GeneratedEnum {
  ...
  def companion: _root_.scalapb.GeneratedEnumCompanion[Status] = com.zz.ady.backstage.idl.Status
  final def asRecognized: _root_.scala.Option[com.zz.ady.backstage.idl.Status.Recognized] = if (isUnrecognized) _root_.scala.None else _root_.scala.Some(this.asInstanceOf[com.zz.ady.backstage.idl.Status.Recognized])
}
