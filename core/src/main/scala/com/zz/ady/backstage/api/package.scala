...
package object api {
  ...
  object ApiStatus extends ApiEnumCompanion[ApiStatus] {
    ...
    final case object Forbidden           extends ApiStatus(4, "Forbidden")
    final case object InternalServerError extends ApiStatus(5, "InternalServerError")
    ...
    final case object NameDuplicated      extends ApiStatus(11, "NameDuplicated")
    final case object NoAccount           extends ApiStatus(12, "NoAccount")

    final case object ReRegAccount        extends ApiStatus(21, "ReRegAccount")
    final case object NameOrCodeDuplicated extends ApiStatus(31, "NameOrCodeDuplicated")
